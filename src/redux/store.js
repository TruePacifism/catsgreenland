...
const initialState = {
  bios: [
    {
      name: 'Август Доброеутро',
      vkId: 731437792,
      text: `Здравствуй, новичок! Вся информация об участниках и беседе в закрепленном сообщение, там же правила. Если у тебя в планах остаться с нами, то будем рады если ты напишешь такой же рассказ и о себе, как и те люди в закрепленной статье. Если есть вопросы - буду рад ответить на них)

Ну здравствуй, читатель. Обращаться ты можешь ко мне Эмма, Эммочка или придумай что-нибудь сам, только, пожалуйста, согласуй со мной! Сразу хотела бы предупредить, что внимание на мой возраст, который может мелькать в чате, обращать не стоит. Я могу серьезно обидеться.

В свободное время я уделяю время игре на гитаре ИЛИ в компик.
Я невероятно дружелюбна и общительна, как в ЛС, так и в беседах, пишите, если что, буду рада. Обожаю проводить время с друзьями и знакомыми на прогулке.

Очень. НУ ОЧЕНЬ люблю котов, кошечек, котят. А еще Женечку. Большую часть времени я слушаю музыку. Кстати, вряд ли вы найдете в моих аудиозаписях что-то знакомое. Люблю черный и зеленые цвета. Живу, кстати, в Калининградской области.


`,
      imagesUrl: [
        'https://sun9-14.userapi.com/impg/xScNgZzV8i8RNkXNou9mH7sI-ksl_3r5-WsFnQ/ZuB6cDv2VFw.jpg?size=545x593&quality=96&sign=c4fa3025412cb03d56e524fdbc40c237&type=album',
      ],
    },
    {
      name: 'Виолетта Гринландская',
      vkId: 601128888,
...
`,
    ...
    {
      name: 'Владимира Кривенко',
      vkId: 634094148,
      text: `Ох.. Хорошо.
Меня зовут Влада, ударение в полном имени Владими́ра.
Я играю на гитаре, изредка рисую и учусь в школе
Люблю физику и литературу (странное сочетание, согласна). Живу в ЛНР, сатанист.
Слушаю разную музыку и под настроение. На этом думаю все.
...
`,
    ...
    {
      name: 'Арсенья Хлоркина',
      vkId: 395500378,
      text: `Я думаю без картинки, просто расскажу о себе, чтобы не быть ноу неймом тут.
Звать меня Армина. Я с Владикавказа. Мне 18 лет. Что касается моей жизни, то она не такая уж и весёлая, но и не скучная. Скорее нейтральная. 7 лет кавказские танцы, но пришлось забросить это дело. Учусь в колледже (последний курс), работаю.
Если будет интересно ещё что-то, расскажу
