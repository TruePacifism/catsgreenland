...
`,
    ...
    },
    {
      ...
      vkId: 335147169,
      text: `Лиза, 19 лет.
Челябинская область, по образованию специалист по социальной работе и психологии, работаю мастером ногтевого сервиса, проживаю одна, люблю проводить время в различных заведениях (клубы, кафе и т.д)
Занималась долгое время волейболом,
Зз козерог,
В людях люблю чувство юмора и искренность,
Общительная, но с достаточно сложным характером.💕`,
      hobbies: [
        {
          name: hobbies.SPORT,
        },
