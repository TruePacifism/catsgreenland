...
export default function LoginPage() {
  ...
  return (
    <Section>
      <Container
        heading={
          'Для доступа к полному функционалу сайта (личный кабинет, лайки на рассказы о себе и т.д.) нужно авторизироваться через Вконтакте'
        }
      >
        <div>
          <p className={styles.notice}>
            Если после авторизации вы все равно не получили доступ - напишите{' '}
            <a
              target="_blank"
              rel="noreferrer"
