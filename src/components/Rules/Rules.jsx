  ...
  notApprovedList: [
    {
      ...
      description: ``,
      special: `(в т.ч. бессмысленное сранье рандомными (мешающими) картинками, репостами, мусорными сообщениями и т.п.).`,
      innerRules: [],
    },
    {
    ...
    {
      title:
        'Сообщения-бомбочки и их скриншоты, @all, @online, ссылки на беседы.',
      description: ``,
      special: `Автоматический запрет ботом, как и выдача наказаний.`,
      innerRules: [],
    },
  ],
};
  ...
  return (
    <>
      ...
      <div className={styles.PSBlock}>
        <p className={styles.PS + ' ' + styles.special}>
